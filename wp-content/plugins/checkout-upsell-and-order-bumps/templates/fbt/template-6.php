<?php
/**
 * Frequently bought together template 6
 *
 * This template can be overridden by copying it to yourtheme/checkout-upsell-woocommerce/fbt/template-6.php.
 *
                ...
                <div class="cuw-actions" style="display: none;">
                    ...
                    <div style="margin-top: 8px;">
                        ...
                        <button type="button"
                                ...
                                style="max-width: 256px; width: 100%; text-transform: initial; white-space: normal; border-radius: 12px; <?php echo esc_attr($data['styles']['cta']); ?>">
