<?php
/**
 * Frequently bought together template 5
 *
 * This template can be overridden by copying it to yourtheme/checkout-upsell-woocommerce/fbt/template-5.php.
 *
            ...
            <?php foreach ($products as $key => $product): ?>
                <div class="cuw-product cuw-product-row  <?php echo esc_attr(implode(' ', $product['classes'])); ?>"
                    ...
                    <div class="cuw-product-wrapper" style="display: flex;">
                        <div class="cuw-product-container" style="border: 1px solid #EAEAEA; border-radius: 16px;">
                            <div class="cuw-product-card" style="<?php echo esc_attr($data['styles']['card']); ?>">
                                ...
                                <div class="cuw-product-image cuw-product-curve-image"
                                     style="box-shadow: none; border-radius: 12px 12px 0 0; <?php echo esc_attr($image_style); ?>">
                            ...
                            <?php if (isset($product['variants']) && !empty($product['variants'])) { ?>
                                ...
                                <div class="cuw-product-card cuw-product-variants" style="<?php echo esc_attr($data['styles']['card']); ?> padding: 16px;">
