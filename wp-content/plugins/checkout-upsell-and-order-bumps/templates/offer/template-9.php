 ...
 * Offer template 9
 *
 * This template can be overridden by copying it to yourtheme/checkout-upsell-woocommerce/offer/template-9.php.
 *
...
<div class="cuw-offer <?php echo !empty($offer['cart_item_key']) ? 'cuw-offer-added' : ''; ?>"
    ...
    <div class="cuw-container"
         style="margin: 12px 0; border-radius: 24px; overflow: hidden; position: relative; padding: 24px; <?php echo esc_attr($offer['styles']['template']); ?>">
        <div class="cuw-product-section" style="display: flex; gap: 24px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
                ...
                <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                    ...
                    <?php if (!empty($offer['template']['title'])) : ?>
                        <div class="cuw-badge">
                                <span class="cuw-offer-title" style="font-weight: bold; padding:4px 6px; border-radius: 8px; <?php echo esc_attr($offer['styles']['title']); ?>">
